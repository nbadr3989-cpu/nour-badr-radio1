/* ==========================================================================
   نور بدر — dashboard.js
   بيقرأ إحصائيات حقيقية من Firebase (كل الزوار من كل الأجهزة) ويعرضها.
   كلمة سر الداشبورد موجودة في js/firebase-config.js داخل ADMIN_CONFIG.
   ========================================================================== */

(() => {
  "use strict";

  // نفس قائمة المنتجات المستخدمة في الموقع، عشان نعرض الاسم جنب كل رقم.
  // لو غيّرت منتجات js/app.js، انسخ نفس الأسماء والـ id هنا (أو سيبها زي ما هي،
  // أي منتج غير موجود هنا هيظهر باسم "منتج رقم #").
  const PRODUCT_NAMES = {
