/* ==========================================================================
   نور بدر — app.js
   البيانات اللي هتعدلها غالبًا (رقم الواتساب، العنوان، المنتجات، التصنيفات)
   موجودة في القسم اللي اسمه "بيانات قابلة للتعديل" تحت.
   بيانات Firebase (التحليلات وتسجيل الدخول) موجودة في js/firebase-config.js.
   ما تحتاجش تعدل أي كود تاني في الملف ده أو في index.html.
   ========================================================================== */
...
(() => {
  ...
  /* ========================================================================
     ⚙️ 1) الإعدادات العامة — CONFIG
     غيّر رقم الواتساب، رقم الهاتف، العنوان، ومواعيد العمل من هنا فقط.
     ======================================================================== */
  const CONFIG = {
